...
NEXTAUTH_URL="https://your-domain.com/v1/iam" # where next-auth is mounted
NEXT_PUBLIC_BASE_URL="https://your-domain.com"

# Hanzo IAM application: sign-in, and the identity that sends email through
# Hanzo notify with the org's email provider
IAM_URL="https://hanzo.id"
IAM_CLIENT_ID="xxx"
IAM_CLIENT_SECRET="xxx"
...
docker run -d \
  ...
  -e IAM_URL="replace" \
  -e IAM_CLIENT_ID="replace" \
  -e IAM_CLIENT_SECRET="replace" \
